<template>
  <div>
    <div class="plan-settings-modal-header">
      <h2 class="p-mr-4">Plan Settings: Documents</h2>
      <div>
        <Button
          label="Close"
    ...
    <div class="setup-content category-section">
...
export default Vue.extend({
  ...
  methods: {
    async setupCategories() {
      ...
      this.$store.dispatch('setupDocumentToCategoriesForCurrentPlan')
      this.planDocumentCategories =
        this.$store.getters.currentPlan.planDocumentCategories
    },
    onFileUpload(e) {
